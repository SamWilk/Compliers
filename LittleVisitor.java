...
public interface LittleVisitor<T> extends ParseTreeVisitor<T> {
	/**
	 * Visit a parse tree produced by {@link LittleParser#r}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitR(LittleParser.RContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link LittleParser#float}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitFloat(LittleParser.FloatContext ctx);
	/**
	 * Visit a parse tree produced by {@link LittleParser#int}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitInt(LittleParser.IntContext ctx);
	/**
